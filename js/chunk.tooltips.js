          ...
          return (function (t) {
            ...
            (_.prototype = {
              ...
              _plugin: function (i) {
                ...
                if ("string" == typeof i) {
                  ...
                  return (
                    e.indexOf(".") > 0
                      ? (n = o.__plugins[e])
                      : t.each(o.__plugins, function (t, i) {
                          return i.name.substring(
                            i.name.length - e.length - 1
                          ) ==
                            "." + e
                            ? ((n = i), !1)
                            : void 0;
                ...
                return (
                  (o.__plugins[i.name] = i),
                  i.core && o.__bridge(i.core, o, i.name),
                  this
                );
              },
              _trigger: function () {
              ...
              instances: function (i) {
                var o = [];
                return (
                  t(i || ".tooltipstered").each(function () {
                    var i = t(this),
              ...
              (t.Tooltipster.prototype = {
                __init: function (i, o) {
                  ...
                  if (
                    ((e._$origin = t(i)),
                    (e.__options = t.extend(!0, {}, n, o)),
                    e.__optionsFormat(),
                    !r.IE || r.IE >= e.__options.IEmin)
                  ) {
                    var s = null;
                    if (
                      (void 0 === e._$origin.data("tooltipster-initialTitle") &&
                        (void 0 === (s = e._$origin.attr("title")) &&
                          (s = null),
                        e._$origin.data("tooltipster-initialTitle", s)),
                      null !== e.__options.content)
                    )
                      e.__contentSet(e.__options.content);
                    else {
                      var _,
                        a = e._$origin.attr("data-tooltip-content");
                      a && (_ = t(a)),
                        _ && _[0]
                          ? e.__contentSet(_.first())
                          : e.__contentSet(s);
                    }
                    e._$origin.removeAttr("title").addClass("tooltipstered"),
                      e.__prepareOrigin(),
                      e.__prepareGC(),
                      t.each(e.__options.plugins, function (t, i) {
                        e._plug(i);
                      }),
                      r.hasTouchCapability &&
                        t(r.window.document.body).on(
                          "touchmove." + e.__namespace + "-triggerOpen",
                          function (t) {
                ...
                __contentInsert: function () {
                  ...
                  return (
                    ...
                    t.__options.functionFormat &&
                      (o = t.__options.functionFormat.call(
                        t,
                        t,
                        { origin: t._$origin[0] },
                        t.__Content
                      )),
                    "string" != typeof o || t.__options.contentAsHTML
                      ? i.empty().append(o)
                      : i.text(o),
                    t
                  );
                ...
                __contentSet: function (i) {
                  return (
                    i instanceof t &&
                      ...
                      (i = i.clone(!0)),
                    (this.__Content = i),
                    this._trigger({ type: "updated", content: i }),
                    this
                  );
                },
                ...
                __geometry: function () {
                  ...
                  var s = o[0].getBoundingClientRect(),
                    ...
                    p = {
                      ...
                      document: {
                        size: { height: _.height(), width: _.width() },
                      },
                      window: {
                        scroll: {
                          left:
                      ...
                      switch (c) {
                        case "circle":
                          var d = h[0],
                            ...
                            f = u - g,
                            m = d - g;
                          (p.origin.size.height = 2 * g),
                            (p.origin.size.width = p.origin.size.height),
                            (p.origin.windowOffset.left += m),
                            (p.origin.windowOffset.top += f);
                          break;
                        case "rect":
                          var w = h[0],
                            v = h[1],
                            y = h[2],
                            b = h[3];
                          (p.origin.size.height = b - v),
                            (p.origin.size.width = y - w),
                            (p.origin.windowOffset.left += w),
                            (p.origin.windowOffset.top += v);
                          break;
                        case "poly":
                          for (
                            var $ = 0, C = 0, O = 0, T = 0, z = "even", E = 0;
                            E < h.length;
                            E++
                          ) {
                            var I = h[E];
                          ...
                          (p.origin.size.height = T - C),
                            (p.origin.size.width = O - $),
                            (p.origin.windowOffset.left += $),
                            (p.origin.windowOffset.top += C);
                      }
                  }
                  for (
                    i._trigger({
                      type: "geometry",
                      edit: function (t) {
                        (p.origin.size.height = t.height),
                          (p.origin.windowOffset.left = t.left),
                          (p.origin.windowOffset.top = t.top),
                          (p.origin.size.width = t.width);
                      },
                      geometry: {
                      ...
                      p.origin.windowOffset.right =
                        p.origin.windowOffset.left + p.origin.size.width,
                      p.origin.windowOffset.bottom =
                        p.origin.windowOffset.top + p.origin.size.height,
                      p.origin.offset.left =
                        p.origin.windowOffset.left + p.window.scroll.left,
                      p.origin.offset.top =
                        p.origin.windowOffset.top + p.window.scroll.top,
                      p.origin.offset.bottom =
                        p.origin.offset.top + p.origin.size.height,
                      p.origin.offset.right =
                        p.origin.offset.left + p.origin.size.width,
                      p.available.document = {
                        bottom: {
                          height:
                            p.document.size.height - p.origin.offset.bottom,
                      ...
                      p.available.window = {
                        bottom: {
                          height: Math.max(
                            p.window.size.height -
                              Math.max(p.origin.windowOffset.bottom, 0),
                            0
                          ),
                        ...
                        right: {
                          ...
                          width: Math.max(
                            p.window.size.width -
                              Math.max(p.origin.windowOffset.right, 0),
                            0
                          ),
                        },
                        top: {
                ...
                __optionsFormat: function () {
                  return (
                    ...
                    null === this.__options.parent
                      ? (this.__options.parent = t(r.window.document.body))
                ...
                __prepareGC: function () {
                  var i = this;
                  return (
                    i.__options.selfDestruction
                      ? (i.__garbageCollector = setInterval(function () {
                          var o = new Date().getTime();
                          (i.__touchEvents = t.grep(
                            i.__touchEvents,
                            function (t, i) {
                              return o - t.time > 6e4;
                            }
                ...
                __prepareOrigin: function () {
                  ...
                  if (
                    ...
                    t.__options.triggerOpen.click ||
                      (t.__options.triggerOpen.tap && r.hasTouchCapability))
                  ) {
                    var i = "";
                    t.__options.triggerOpen.click &&
                      (i += "click." + t.__namespace + "-triggerOpen "),
                      t.__options.triggerOpen.tap &&
                        r.hasTouchCapability &&
                        (i += "touchend." + t.__namespace + "-triggerOpen"),
                  ...
                  return (
                    (t.__options.triggerOpen.mouseenter ||
                      ...
                      ((i = ""),
                      t.__options.triggerOpen.mouseenter &&
                        (i += "mouseenter." + t.__namespace + "-triggerOpen "),
                      t.__options.triggerOpen.touchstart &&
                        r.hasTouchCapability &&
                        (i += "touchstart." + t.__namespace + "-triggerOpen"),
                      t._$origin.on(i, function (i) {
                        (!t._touchIsTouchEvent(i) &&
                          t._touchIsEmulatedEvent(i)) ||
                          ((t.__pointerIsOverOrigin = !0), t._openShortly(i));
                      })),
                    (t.__options.triggerClose.mouseleave ||
                      ...
                      ((i = ""),
                      t.__options.triggerClose.mouseleave &&
                        (i += "mouseleave." + t.__namespace + "-triggerOpen "),
                      t.__options.triggerClose.touchleave &&
                        r.hasTouchCapability &&
                        (i +=
                          "touchend." +
                          ...
                          "-triggerOpen"),
                      t._$origin.on(i, function (i) {
                        t._touchIsMeaningfulEvent(i) &&
                          (t.__pointerIsOverOrigin = !1);
                      })),
                    t
                  );
                },
                __prepareTooltip: function () {
                  ...
                  return (
                    i._$tooltip
                      ...
                      .css({ "pointer-events": o, zIndex: i.__options.zIndex }),
                ...
                __scrollHandler: function (i) {
                  ...
                  if (o.__options.triggerClose.scroll) o._close(i);
                    ...
                    var n = null;
                    if (i.target === r.window.document)
                      o.__Geometry.origin.fixedLineage ||
                        (o.__options.repositionOnScroll && o.reposition(i));
                    else {
                      n = o.__geometry();
                      var s = !1;
                      if (
                        ("fixed" != o._$origin.css("position") &&
                          o.__$originParents.each(function (i, o) {
                            var e = t(o),
                              r = e.css("overflow-x"),
                              _ = e.css("overflow-y");
                            if ("visible" != r || "visible" != _) {
                              ...
                              if (
                                "visible" != r &&
                                (n.origin.windowOffset.left < a.left ||
                                  n.origin.windowOffset.right > a.right)
                              )
                                return (s = !0), !1;
                              if (
                                "visible" != _ &&
                                (n.origin.windowOffset.top < a.top ||
                                  n.origin.windowOffset.bottom > a.bottom)
                              )
                                return (s = !0), !1;
                            }
                        ...
                        o._$tooltip.css("visibility", "hidden");
                      else if (
                        (o._$tooltip.css("visibility", "visible"),
                        o.__options.repositionOnScroll)
                      )
                        o.reposition(i);
                      else {
                        var _ =
                            n.origin.offset.left -
                            o.__Geometry.origin.offset.left,
                          a =
                            n.origin.offset.top -
                            o.__Geometry.origin.offset.top;
                        o._$tooltip.css({
                  ...
                  if (
                    ...
                    if ("closed" != n.__state) {
                      var a = !0,
                        l =
                          new Date().getTime() +
                          n.__options.animationDuration[1];
                      if (
                        ("disappearing" == n.__state &&
                          l > n.__closingTime &&
                          n.__options.animationDuration[1] > 0 &&
                          (a = !1),
                        a)
                      ) {
                        (n.__closingTime = l),
                          "disappearing" != n.__state &&
                            n.__stateSet("disappearing");
                        var p = function () {
                          clearInterval(n.__tracker),
                            ...
                            n.__$originParents.each(function (i, o) {
                              t(o).off(
                                "scroll." + n.__namespace + "-triggerClose"
                              );
                            }),
                            (n.__$originParents = null),
                            t(r.window.document.body).off(
                              "." + n.__namespace + "-triggerClose"
                            ),
                            n._$origin.off(
                              "." + n.__namespace + "-triggerClose"
                        ...
                        r.hasTransitions
                          ...
                          : n._$tooltip
                              .stop()
                              .fadeOut(n.__options.animationDuration[1], p);
                      }
                    } else _();
                  }
                  return n;
                  ...
                  if (!n.__destroying && e(n._$origin) && n.__enabled) {
                    ...
                    if (
                      ("closed" == n.__state &&
                        ...
                        s &&
                          n.__options.functionBefore &&
                          (s = n.__options.functionBefore.call(n, n, {
                            event: i,
                            origin: n._$origin[0],
                          }))),
                      ...
                      if ("closed" !== n.__state)
                            ...
                            ? (n.__stateSet("appearing"),
                              r.hasTransitions
                                ? (n._$tooltip
                                  ...
                                  n.__options.animationDuration[0] > 0 &&
                                    n._$tooltip.delay(
                                      n.__options.animationDuration[0]
                                    ),
                                  n._$tooltip.queue(a))
                                : n._$tooltip.stop().fadeIn(a))
                            : "stable" == n.__state && a();
                      else {
                        if (
                          (n.__stateSet("appearing"),
                          (_ = n.__options.animationDuration[0]),
                          n.__contentInsert(),
                          n.reposition(i, !0),
                          r.hasTransitions
                            ? (n._$tooltip
                                .addClass(
                                  "tooltipster-" + n.__options.animation
                                )
                                .addClass("tooltipster-initial")
                                .css({
                                  "-moz-animation-duration":
                                    n.__options.animationDuration[0] + "ms",
                                  "-ms-animation-duration":
                                    n.__options.animationDuration[0] + "ms",
                                  "-o-animation-duration":
                                    n.__options.animationDuration[0] + "ms",
                            ...
                            : n._$tooltip
                                .css("display", "none")
                                .fadeIn(n.__options.animationDuration[0], a),
                          n.__trackerStart(),
                          t(r.window)
                            .on(
                              "resize." + n.__namespace + "-triggerClose",
                              function (i) {
                                var o = t(document.activeElement);
                                ((o.is("input") || o.is("textarea")) &&
                                  t.contains(n._$tooltip[0], o[0])) ||
                                  n.reposition(i);
                              }
                            )
                            .on(
                          ...
                          n.__options.interactive && (l = l.add(n._$tooltip)),
                            ...
                            l
                              .on(c, function (t) {
                                if (
                                  n._touchIsTouchEvent(t) ||
                                  !n._touchIsEmulatedEvent(t)
                                ) {
                                  var i =
                                    "mouseleave" == t.type
                                      ? n.__options.delay
                                      : n.__options.delayTouch;
                                  n._trigger({
                                    delay: i[1],
                                    dismissable: !0,
                                    event: t,
                        ...
                        n.__options.triggerClose.originClick &&
                          n._$origin.on(
                            "click." + n.__namespace + "-triggerClose",
                            function (t) {
                              n._touchIsTouchEvent(t) ||
                                n._touchIsEmulatedEvent(t) ||
                                n._close(t);
                          ...
                          (n.__options.triggerClose.click ||
                                ...
                                n.__options.triggerClose.click &&
                                  ...
                                  n.__options.triggerClose.tap &&
                                    ...
                                    (i +=
                                      ...
                                      "-triggerClose"),
                                  o.on(i, function (i) {
                                    n._touchIsMeaningfulEvent(i) &&
                                      (n._touchRecordEvent(i),
                                      (n.__options.interactive &&
                                        t.contains(n._$tooltip[0], i.target)) ||
                                        n._close(i));
                                  }),
                                  n.__options.triggerClose.tap &&
                                    r.hasTouchCapability &&
                          ...
                          n._trigger("ready"),
                          n.__options.functionReady &&
                            n.__options.functionReady.call(n, n, {
                              origin: n._$origin[0],
                              tooltip: n._$tooltip[0],
                            });
                      }
                  ...
                  if (
                    ...
                    var e =
                      0 == t.type.indexOf("touch")
                        ...
                        : i.__options.delay;
                    e[0]
                      ? (i.__timeouts.open = setTimeout(function () {
                          (i.__timeouts.open = null),
                            i.__pointerIsOverOrigin &&
                            i._touchIsMeaningfulEvent(t)
                              ? (i._trigger("startend"), i._open(t))
                              : i._trigger("startcancel");
                        }, e[0]))
                      : (i._trigger("startend"), i._open(t));
                  }
                  return i;
                ...
                _plug: function (i) {
                  ...
                  return (
                    o.instance &&
                      t.tooltipster.__bridge(o.instance, this, o.name),
                    this
                  );
                },
                ...
                _touchIsMeaningfulEvent: function (t) {
                  return (
                    (this._touchIsTouchEvent(t) &&
                      !this._touchSwiped(t.target)) ||
                    (!this._touchIsTouchEvent(t) &&
                      !this._touchIsEmulatedEvent(t))
                  );
                },
                ...
                _touchSwiped: function (t) {
                  for (
                    var i = !1, o = this.__touchEvents.length - 1;
                    o >= 0;
                    o--
                  ) {
                ...
                _trigger: function () {
                  ...
                  return (
                    "string" == typeof i[0] && (i[0] = { type: i[0] }),
                    (i[0].instance = this),
                ...
                _unplug: function (i) {
                  ...
                  if (o[i]) {
                    ...
                    e.instance &&
                      t.each(e.instance, function (t, e) {
                    ...
                    if (
                      ...
                      if (r.hasTransitions) {
                        ...
                        i._$tooltip.addClass("tooltipster-update-" + o),
                          setTimeout(function () {
                            "closed" != i.__state &&
                              i._$tooltip.removeClass(
                                "tooltipster-update-" + o
                              );
                          }, 1e3);
                      } else
                          ...
                          : "current" == i.__options.restoration &&
                            (e =
                              "string" == typeof i.__Content
                                ? i.__Content
                                : t("<div></div>").append(i.__Content).html()),
                  ...
                  return (
                    o.__destroyed
                      ...
                      : "closed" != o.__state &&
                        e(o._$origin) &&
                        (i || e(o._$tooltip)) &&
                        (i || o._$tooltip.detach(),
                        (o.__Geometry = o.__geometry()),
                        o._trigger({
                          type: "reposition",
                          event: t,
                ...
                if ("string" == typeof i[0]) {
                  ...
                  return (
                    this.each(function () {
                      ...
                      if ("function" != typeof s[i[0]])
                        throw new Error('Unknown method "' + i[0] + '"');
                      this.length > 1 &&
                        "content" == i[0] &&
                        (i[1] instanceof t ||
                          ("object" == typeof i[1] &&
              ...
              (i.prototype = {
                ...
                constrain: function (t, i) {
                  return (
                    (this.constraints = { width: t, height: i }),
                    this.__$tooltip.css({
                      display: "block",
                      height: "",
                      overflow: "auto",
            ...
            -1 != a.indexOf("msie")
              ? (r.IE = parseInt(a.split("msie")[1]))
              : -1 !== a.toLowerCase().indexOf("trident") &&
                -1 !== a.indexOf(" rv:11")
              ? (r.IE = 11)
              : -1 != a.toLowerCase().indexOf("edge/") &&
                (r.IE = parseInt(a.toLowerCase().split("edge/")[1]));
              ...
              t.tooltipster._plugin({
                ...
                instance: {
                  ...
                  __create: function () {
                    ...
                    this.__options.arrow ||
                      ...
                      this.__options.minWidth &&
                        i.css("min-width", this.__options.minWidth + "px"),
                      this.__options.maxWidth &&
                        i.css("max-width", this.__options.maxWidth + "px"),
                      (this.__instance._$tooltip = i),
                  ...
                  __optionsFormat: function () {
                    var i = this;
                    if (
                      ((i.__options = i.__instance._optionsExtract(
                        l,
                        i.__defaults()
                      )),
                      i.__options.position &&
                        (i.__options.side = i.__options.position),
                      "object" != typeof i.__options.distance &&
                        (i.__options.distance = [i.__options.distance]),
                      i.__options.distance.length < 4 &&
                        (void 0 === i.__options.distance[1] &&
                          (i.__options.distance[1] = i.__options.distance[0]),
                        void 0 === i.__options.distance[2] &&
                          (i.__options.distance[2] = i.__options.distance[0]),
                        void 0 === i.__options.distance[3] &&
                          (i.__options.distance[3] = i.__options.distance[1])),
                      (i.__options.distance = {
                      ...
                      (i.__options.side = [
                        ...
                        "left" == i.__options.side[0] ||
                        "right" == i.__options.side[0]
                          ? i.__options.side.push("top", "bottom")
                          : i.__options.side.push("right", "left");
                    }
                  ...
                  __reposition: function (i, o) {
                    ...
                    switch (
                      ...
                      t.each(["window", "document"], function (e, p) {
                        ...
                        if (
                          ...
                          1 == c ||
                            (0 != c &&
                              0 == l &&
                              ("window" != p || n.__options.viewportAware)))
                        )
                          for (e = 0; e < n.__options.side.length; e++) {
                            var h = { horizontal: 0, vertical: 0 },
                              d = n.__options.side[e];
                            "top" == d || "bottom" == d
                              ? (h.vertical = n.__options.distance[d])
                              : (h.horizontal = n.__options.distance[d]),
                              n.__sideChange(_, d),
                              t.each(
                                ["natural", "constrained"],
                                function (t, e) {
                                    ...
                                    var _ = {
                                      ...
                                      u = (
                                        "natural" == e
                                          ? a.free()
                                          : a.constrain(
                                              o.geo.available[p][d].width -
                                                h.horizontal,
                                              o.geo.available[p][d].height -
                                                h.vertical
                                            )
                                      ).measure();
                                    if (
                                      ...
                                      "window" == p &&
                                        (_.fits
                                          ? (_.whole =
                                              "top" == d || "bottom" == d
                                                ? o.geo.origin.windowOffset
                                                    .right >=
                                                    n.__options
                                                      .minIntersection &&
                                                  o.geo.window.size.width -
                                                    o.geo.origin.windowOffset
                                                      .left >=
                                                    n.__options.minIntersection
                                                : o.geo.origin.windowOffset
                                                    .bottom >=
                                                    n.__options
                                                      .minIntersection &&
                      ...
                      r.sort(function (t, i) {
                        ...
                        if (t.whole && i.whole) {
                          ...
                          return (e = n.__options.side.indexOf(i.side)) > o
                            ? -1
                            : o > e
                            ? 1
                            : "natural" == t.mode
                        ...
                        return t.fits && !i.fits
                          ? -1
                          : !t.fits && i.fits
                          ? 1
                          : t.fits && i.fits
                          ? ((o = n.__options.side.indexOf(t.side)),
                            (e = n.__options.side.indexOf(i.side)) > o
                              ? -1
                              : o > e
                              ? 1
                              : "natural" == t.mode
                    ...
                    switch (e.side) {
                      case "left":
                        e.coord.left =
                          o.geo.origin.windowOffset.left - e.outerSize.width;
                        break;
                      case "right":
                        e.coord.left =
                          o.geo.origin.windowOffset.right +
                          e.distance.horizontal;
                        break;
                      case "top":
                        e.coord.top =
                          o.geo.origin.windowOffset.top - e.outerSize.height;
                        break;
                      case "bottom":
                        e.coord.top =
                          o.geo.origin.windowOffset.bottom +
                          e.distance.vertical;
                    }
                    "window" == e.container
                      ? "top" == e.side || "bottom" == e.side
                        ? e.coord.left < 0
                          ? o.geo.origin.windowOffset.right -
                            ...
                            : (e.coord.left =
                                ...
                                1)
                          : e.coord.left >
                              o.geo.window.size.width - e.size.width &&
                            (o.geo.origin.windowOffset.left +
                              this.__options.minIntersection <=
                            o.geo.window.size.width
                              ? (e.coord.left =
                                  o.geo.window.size.width - e.size.width)
                        ...
                        ? o.geo.origin.windowOffset.bottom -
                          ...
                          : (e.coord.top =
                              ...
                              1)
                        : e.coord.top >
                            o.geo.window.size.height - e.size.height &&
                          (o.geo.origin.windowOffset.top +
                            this.__options.minIntersection <=
                          o.geo.window.size.height
                            ? (e.coord.top =
                                o.geo.window.size.height - e.size.height)
                      ...
                      (o.tooltipClone = _[0]),
                      (o.tooltipParent =
                        n.__instance.option("parent").parent[0]),
                      (o.mode = e.mode),
                      (o.whole = e.whole),
                      ...
                      delete e.whole,
                      (e.distance =
                        e.distance.horizontal || e.distance.vertical);
                    var c,
                      h,
                      d,
                      u = t.extend(!0, {}, e);
                    if (
                      ...
                      var g = n.__options.functionPosition.call(
                        n,
                        n.__instance,
                        o,
                        u
                    ...
                    a.destroy(),
                      "top" == e.side || "bottom" == e.side
                        ? ((c = { prop: "left", val: e.target - e.coord.left }),
                          (h = e.size.width - this.__options.minIntersection))
                        : ((c = { prop: "top", val: e.target - e.coord.top }),
                          (h = e.size.height - this.__options.minIntersection)),
                      c.val < this.__options.minIntersection
                        ? (c.val = this.__options.minIntersection)
                        : c.val > h && (c.val = h),
                      (d = o.geo.origin.fixedLineage
                        ? o.geo.origin.windowOffset
                        : {
                            left:
                              o.geo.origin.windowOffset.left +
                              o.geo.window.scroll.left,
                            top:
                              o.geo.origin.windowOffset.top +
                              o.geo.window.scroll.top,
                          }),
                      (e.coord = {
                        left:
                          d.left +
                          (e.coord.left - o.geo.origin.windowOffset.left),
                        top:
                          d.top + (e.coord.top - o.geo.origin.windowOffset.top),
                      }),
                      n.__sideChange(n.__instance._$tooltip, e.side),
                      o.geo.origin.fixedLineage
                        ? n.__instance._$tooltip.css("position", "fixed")
                        : n.__instance._$tooltip.css("position", ""),
                      n.__instance._$tooltip
                        .css({
                          left: e.coord.left,
                          top: e.coord.top,
                        ...
                        .css({ left: "", top: "" })
                        .css(c.prop, c.val),
                      n.__instance._$tooltip.appendTo(
                        n.__instance.option("parent")
                      ),
                      n.__instance._trigger({
                        type: "repositioned",
                        event: i,
                  ...
                  __targetFind: function (t) {
                    ...
                    if (
                      ...
                      (i.top = Math.floor(
                        t.geo.origin.windowOffset.left +
                          t.geo.origin.size.width / 2
                      )),
                        (i.bottom = i.top),
                        (i.left = Math.floor(
                          t.geo.origin.windowOffset.top +
                            t.geo.origin.size.height / 2
                        )),
                        (i.right = i.left);
                    else {
                      var e = o[0];
                      (i.top = Math.floor(e.left + (e.right - e.left) / 2)),
                        (e =
                          o.length > 2 ? o[Math.ceil(o.length / 2) - 1] : o[0]),
