    ...
    if (a) {
      ...
      if (0 < f.length) {
        ...
        jQuery("#" + s.gf_vars.message_id).html(""),
          a[l].length < d && gfMultiFileUploader.toggleDisabled(s, !1);
      } else a[l] = null;
...
function gformGetOptionLabel(e, r, t, i, n) {
  ...
  return (
    window.gform_format_option_label &&
      (d = gform_format_option_label(d, l, s, t, o, i, n)),
    d
  );
}
...
function gformToggleCheckboxes(e) {
  ...
  i.each(function () {
    ...
    o && o.runCalcs(n, o.formulaFields);
}
        ...
        if (n.hasOwnProperty(i)) {
          ...
          if (n[i][3]) l = n[i][3];
            ...
            var f = jQuery(".gfield_price input[name=input_" + a + "]").is(
              ...
              d = jQuery('.gfield_price input[name="input_' + o + '"]').is(
                "input[type=checkbox]"
              );
            (s || f || d) && (l = "price");
          }
  ...
  ((function (c, b) {
    ...
    function i(e) {
      ...
      (m = t.settings.multipart_params.form_id),
        (c.uploaders[r.container] = t).bind("Init", function (e, r) {
          ...
          var t = e.settings.multipart_params.field_id,
            ...
            n = d(t);
          0 < i && i <= n && c.toggleDisabled(e.settings, !0);
        }),
        (c.toggleDisabled = function (e, r) {
        ...
        t.bind("FilesAdded", function (o, e) {
          ...
          if (0 < l && l <= f)
            ...
            b.each(e, function (e, r) {
              ...
              if (r.status == plupload.FAILED || (0 < l && l <= f))
                ...
                (n = gform
                  ...
                  .format(r.id, w(r.name), t, F.cancel_upload, i, F.cancel)),
            ...
            0 == t.length && (t = b(r)),
              ...
              0 < l &&
                l <= f &&
                (c.toggleDisabled(o.settings, !0),
                p(o.settings.gf_vars.message_id, F.max_reached)),
        ...
        t.bind("Error", function (e, r) {
          if (r.code === plupload.FILE_EXTENSION_ERROR) {
            ...
            p(
              ...
              r.file.name + " - " + F.invalid_file_extension + " " + t
            );
          } else if (r.code === plupload.FILE_SIZE_ERROR)
            p(
              e.settings.gf_vars.message_id,
              r.file.name + " - " + F.file_exceeds_limit
            );
          else {
            var i =
              "Error: " +
              ...
              100 == r.percent &&
                (i.status && "ok" == i.status
                  ? ((n = _),
                    ...
                    (f = a),
                    (s = h()),
                    (d = b("#gform_uploaded_files_" + m)),
                    (c = v(l)),
                    (s[c] = f),
                    d.val(b.toJSON(s)))
                  : p(
                      e.settings.gf_vars.message_id,
                      F.unknown_error + ": " + r.name
                    ));
          }
        }),
    ...
    b(document).bind("gform_post_render", function (e, r) {
      ...
      0 < t.length &&
        t.submit(function () {
          var t = !1;
          if (
            (b.each(c.uploaders, function (e, r) {
              if (0 < r.total.queued) return !(t = !0);
            }),
            t)
          )
            return (
              alert(F.currently_uploading),
