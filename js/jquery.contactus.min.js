...
$jscomp.findInternal = function (b, d, a) {
  ...
  for (var c = b.length, f = 0; f < c; f++) {
    var e = b[f];
    if (d.call(a, e, f, b)) return { i: f, v: e };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
(function (b) {
  function d(a, c) {
    ...
    this._interval;
    this._timeout;
    this._wellcomeMessagesDone =
      this._formOpened =
      this._callbackOpened =
      this._popupOpened =
      this._menuOpened =
      this._animation =
        !1;
  ...
  d.prototype.init = function () {
    ...
    this.settings.forms.dynamic_form = { header: "" };
    this.$element
      .addClass("arcontactus-widget")
      .addClass("arcontactus-message")
      .addClass("layout-" + this.settings.layout);
    ...
    (null != this.settings.style &&
      "popup" != this.settings.style &&
      "" != this.settings.style) ||
      !this.settings.popupAnimation ||
    ...
    if (this.settings.items.length) {
      ...
      if ("regular" == this.settings.mode || "single" == this.settings.mode)
        if ((this._initMessengersBlock(), "single" == this.settings.mode)) {
      ...
      null !== this.settings.online &&
        ((a = b("<div>", {
          class:
            "arcu-online-badge " +
            (!0 === this.settings.online ? "online" : "offline"),
        })),
  ...
  d.prototype._initForms = function () {
    var a = this,
      c = b("<div>", { class: "arcu-forms-container" }),
      f = b("<div>", {
        class: "arcu-close",
    ...
    b.each(a.settings.forms, function (e) {
      if (this.icon) {
        var f = b("<div>", { id: "form-icon-" + e, class: "form-icon" });
        f.append(this.icon);
        a.$element.find(".arcontactus-message-button").append(f);
      }
      f = b("<div>", { class: "arcu-form-container", id: "arcu-form-" + e });
      e =
        "undefined" !== typeof this.action
          ? b("<form>", {
              action: this.action,
              method: "POST",
              class: "arcu-form",
      ...
      if ("string" == typeof this.header) {
        ...
        var g = b("<div>", { class: "arcu-form-header-content" });
        g.html(this.header.content);
        var k = b("<div>", { class: "arcu-form-header-icon" });
      ...
      f.append(e);
      "string" == typeof this.success &&
        ((e = b("<div>", { class: "arcu-form-success" })),
        (d = b("<div>")),
        d.html(this.success),
        e.append(d),
        f.append(e));
      "string" == typeof this.error &&
        ((e = b("<div>", { class: "arcu-form-error" })),
        (d = b("<div>")),
        d.html(this.error),
        e.append(d),
        f.append(e));
  ...
  d.prototype._initFormButtons = function (a, c) {
    ...
    b.each(a.buttons, function (e) {
      e = a.buttons[e];
      var d = b("<div>", { class: "arcu-form-group arcu-form-button" }),
        h = "";
    ...
    b.each(a.fields, function (f) {
      ...
      f = b("<div>", {
        class:
          ...
          " arcu-form-group-" +
          e.name +
          (e.required ? " arcu-form-group-required" : ""),
      });
      var d = "<input>";
      switch (e.type) {
        case "textarea":
      ...
      if (e.label) {
        var h = b("<div>", { class: "arcu-form-label" });
        h.html(e.label);
        f.append(h);
      }
      var g = b(d, {
      ...
      "dropdown" == e.type &&
        b.each(e.values, function (a) {
          var c = e.values[a],
            f = e.values[a];
          "object" == typeof e.values[a] &&
            ((c = e.values[a].value), (f = e.values[a].label));
          a = b("<option>", { value: c });
          a.text(f);
          g.append(a);
        });
      f.append(g);
      f.append(b("<div>", { class: "arcu-form-field-errors" }));
      c.append(f);
    });
  };
  d.prototype._initPopups = function () {
    var a = this,
      c = b("<div>", { class: "popups-block arcuAnimated" }),
      f = b("<div>", { class: "popups-list-container" });
    b.each(this.popups, function () {
      var c = b("<div>", { class: "arcu-popup", id: "arcu-popup-" + this.id }),
        d = b("<div>", {
          class: "arcu-popup-header",
          style: a.settings.theme
            ? "background-color:" + a.settings.theme
            : null,
        }),
        h = b("<div>", {
      ...
      d.append(h);
      d.append(g);
      h = b("<div>", { class: "arcu-popup-content" });
  ...
  d.prototype._initMessengersBlock = function () {
    var a = b("<div>", { class: "messangers-block arcuAnimated" }),
      c = b("<div>", { class: "messangers-list-container" });
    if ("personal" == this.settings.layout) {
      var f = b("<div>", { class: "arcu-items-header" });
      f.html(this.settings.itemsHeader);
      var e = b("<div>", { class: "arcu-wellcome" });
      c.append(e);
      c.append(f);
    }
    f = b("<ul>", { class: "messangers-list" });
    this.settings.itemsAnimation &&
      f.addClass("arcu-" + this.settings.itemsAnimation);
    ...
    if (this.settings.showMenuHeader) {
      ...
      var d = b("<div>", {
        class:
          "arcu-menu-header-content arcu-text-" +
          this.settings.menuHeaderTextAlign,
      });
      d.html(this.settings.menuHeaderText);
      if (this.settings.menuHeaderIcon) {
        var h = b("<div>", { class: "arcu-header-icon" });
        this.settings.menuHeaderIcon.match(/^https?:\/\//)
          ? h
              .css(
                "background-image",
                "url(" + this.settings.menuHeaderIcon + ")"
              )
              .addClass("arcu-bg-image")
          : h.append(this.settings.menuHeaderIcon);
        if (null !== this.settings.menuHeaderOnline) {
          var g = b("<div>", {
            class:
              "arcu-online-badge " +
              (this.settings.menuHeaderOnline ? "online" : "offline"),
      ...
      e.append(d);
      this.settings.menuSubheaderText &&
        ((d = b("<div>", {
          class:
            "arcu-menu-subheader arcu-text-" +
            this.settings.menuHeaderTextAlign,
        })),
        d.html(this.settings.menuSubheaderText),
        e.append(d));
      this.settings.showHeaderCloseBtn &&
        ((d = b("<div>", {
          class: "arcu-header-close",
          style:
            "color:" +
            this.settings.headerCloseBtnColor +
            "; background:" +
            this.settings.headerCloseBtnBgColor,
        })),
    ...
    "rounded" == this.settings.itemsIconType
      ? f.addClass("rounded-items")
      : f.addClass("not-rounded-items");
    c.append(f);
    a.append(c);
  ...
  d.prototype._appendMessengerIcons = function (a, c) {
    ...
    b.each(c, function (c) {
      ...
      var g =
        "rounded" == f.settings.itemsIconType
          ? this.noContainer
            ? b("<span>", {
                style: this.color
      ...
      if ("undefined" !== typeof this.online && null !== this.online) {
        var k = b("<div>", {
          class:
            "arcu-online-badge " + (!0 === this.online ? "online" : "offline"),
        });
        g.append(k);
      }
      g.append(this.icon);
      e.append(g);
      g = b("<div>", { class: "arcu-item-label" });
      k = b("<div>", { class: "arcu-item-title" });
      k.text(this.title);
      g.append(k);
      "undefined" != typeof this.subTitle &&
        this.subTitle &&
        ((k = b("<div>", { class: "arcu-item-subtitle" })),
      ...
      if (this.items) {
        ...
        g = b("<div>", {
          ...
          style:
            "background-color:" +
            f.settings.subMenuHeaderBackground +
            "; color: " +
            e.subMenuHeaderIconColor,
        });
        k = b("<div>", {
        ...
        g.append(k);
        k = b("<div>", { class: "arcu-submenu-container" });
        n = b("<ul>", { class: "arcu-submenu" });
        k.append(g);
        k.append(n);
  ...
  d.prototype._initMessageButton = function () {
    ...
    var f = b("<div>", { class: "static" }),
      e = b("<div>", { class: "img-" + this.settings.buttonIconSize });
    e.append(this.settings.buttonIcon);
    !1 !== this.settings.buttonText
      ? e.append("<p>" + this.settings.buttonText + "</p>")
      : c.addClass("no-text");
    f.append(e);
    e = b("<div>", { class: "callback-state", style: a._colorStyle() });
    e.append(this.settings.callbackStateIcon);
    var d = b("<div>", { class: "icons hide" }),
      h = b("<div>", { class: "icons-line" });
    b.each(this.settings.items, function (c) {
      this.includeIconToSlider &&
        ((c = b("<span>", { style: a._colorStyle() })),
        c.append(this.icon),
        h.append(c));
    });
    d.append(h);
  ...
  d.prototype._initPrompt = function () {
    ...
    var f = b("<div>", { class: "arcontactus-prompt-inner" });
    a.append(c).append(f);
    this.$element.append(a);
  };
  d.prototype._initEvents = function () {
    ...
    a.find(".arcontactus-message-button")
      ...
      .on("mouseup", function (b) {
        if (
          (c.settings.drag && b.pageX === c.x && b.pageY === c.y) ||
          !c.settings.drag
        ) {
          if ("regular" == c.settings.mode)
            ...
            c._callbackOpened ||
            c._formOpened
              ? (c._menuOpened && c.closeMenu(),
                c._popupOpened && c.closePopup())
              : c.openMenu();
          else if ("single" == c.settings.mode) {
            var e = a.find(".messangers-list li:first-child a");
            e.attr("href") || e.click();
          } else c.showForm("callback");
          b.preventDefault();
        }
      });
    this.settings.drag &&
    ...
    a.find("form").on("submit", function (f) {
      ...
      c.settings.reCaptcha
        ? grecaptcha
            .execute(c.settings.reCaptchaKey, {
  ...
  d.prototype._processFormErrors = function (a, c) {
    0 == c.success &&
      b.each(c.errors, function (b) {
        a.find(".arcu-form-group-" + b).addClass("has-error");
        a.find(".arcu-form-group-" + b)
          .find(".arcu-form-field-errors")
          .html(c.errors[b].join("<br/>"));
      });
  };
  d.prototype.sendFormData = function (a) {
    var c = this,
      d = c.$element;
    d.trigger("arcontactus.beforeSendFormData", { form: a });
    b.ajax({
      url: a.attr("action"),
      type: a.attr("method"),
      dataType: "json",
      ...
      success: function (b) {
        ...
        b.success
          ? (a.parent().find(".arcu-form-success").addClass("active"),
            a.parent().find(".arcu-form-error").removeClass("active"),
            d.trigger("arcontactus.successSendFormData", { form: a, data: b }))
          : (b.errors && c._processFormErrors(a, b),
            d.trigger("arcontactus.errorSendFormData", { form: a, data: b }));
      },
      error: function () {
        c._clearFormErrors(a);
        ...
        d.trigger("arcontactus.errorSendFormData", { form: a, data: null });
      },
    });
  };
  ...
  d.prototype.closePopup = function () {
    ...
    a.find(".arcu-popup").hasClass("show-messageners-block") &&
      ...
      a
        .find(".arcu-popup")
        .removeClass(this.settings.menuInAnimationClass)
        .addClass(this.settings.menuOutAnimationClass),
      setTimeout(function () {
        a.removeClass("popup-opened");
      }, 150),
  ...
  d.prototype.openMenu = function () {
    if ("callback" == this.settings.mode)
      return console.log("Widget in callback mode"), !1;
  ...
  d.prototype.closeMenu = function () {
    ...
    a.find(".messangers-block").hasClass(this.settings.menuInAnimationClass) &&
      ...
      a
        ...
        .addClass(this.settings.menuOutAnimationClass),
      setTimeout(function () {
        a.find(".messangers-block").removeClass(
          b.settings.menuOutAnimationClass
        );
      }, 1e3),
      a.find(".arcontactus-close").removeClass("show-messageners-block"),
  ...
  d.prototype.openCallbackPopup = function () {
    ...
    a.find(".pulsation").addClass("stop");
    a.find(
      ".callback-countdown-block-phone, .callback-countdown-block-sorry, .callback-countdown-block-timer"
  ...
  d.prototype.startAnimation = function () {
    if (this._menuOpened || this._formOpened) return !1;
    var a = this.$element,
      b = this,
      d = a.find(".icons-line"),
      e = a.find(".static"),
    ...
    if ("huge" === this.settings.buttonSize)
      var h = 2,
        g = 0;
    "large" === this.settings.buttonSize && ((h = 2), (g = 0));
    "medium" === this.settings.buttonSize && ((h = 4), (g = -2));
    "small" === this.settings.buttonSize && ((h = 4), (g = -2));
    var k = a.find(".icons-line>span").length,
      l = 0;
    if (0 === this.settings.iconsAnimationSpeed) return !1;
    this._animation = !0;
    this._interval = setInterval(function () {
      0 === l && (d.parent().removeClass("hide"), e.addClass("hide"));
      var a = "translate(" + -(m * l + h) + "px, " + g + "px)";
      d.css({ "-webkit-transform": a, "-ms-transform": a, transform: a });
      l++;
      l > k &&
        (l > k + 1 &&
          (b.settings.iconsAnimationPause &&
  ...
  d.prototype.stopAnimation = function (a) {
    ...
    a || ((this._animation = !1), clearTimeout(this._timeout));
    var b = this.$element;
    a = b.find(".icons-line");
    b = b.find(".static");
  ...
  d.prototype.showForm = function (a) {
    ...
    this.$element.find("#form-icon-" + a).length &&
      (this.$element.find("#form-icon-" + a).addClass("active"),
      this.$element
        .find(".arcontactus-message-button .static")
        .addClass("hide"));
    this.$element.trigger("arcontactus.showFrom", { id: a });
  };
  ...
  d.prototype._insertPromptTyping = function () {
    var a = this.$element.find(".arcontactus-prompt-inner"),
      c = b("<div>", { class: "arcontactus-prompt-typing" }),
      d = b("<div>");
    c.append(d);
    c.append(d.clone());
    c.append(d.clone());
  ...
  d.prototype.showWellcomeTyping = function () {
    ...
    if (0 == a.find(".arcu-wellcome-msg.typing").length) {
      var d = b("<div>", { class: "arcu-wellcome-msg typing" }),
        e = b("<div>", { class: "arcu-wellcome-icon" });
      e.html(c.clone());
      c = b("<div>", { class: "arcu-wellcome-time" });
      var m = new Date();
      c.html(
        ("0" + m.getHours()).slice(-2) + ":" + ("0" + m.getMinutes()).slice(-2)
      );
      m = b("<div>", { class: "arcu-wellcome-content" });
      var h = b("<div>", { class: "arcontactus-prompt-typing" }),
        g = b("<div>");
      h.append(g);
      h.append(g.clone());
      h.append(g.clone());
  ...
  d.prototype.showWellcomeMessage = function (a) {
    ...
    b.find(".arcu-wellcome-msg.typing").length &&
      (b
        .find(".arcu-wellcome-msg.typing .arcu-wellcome-content")
        .html(a.content),
  ...
  d.prototype.hideSubmenu = function (a) {
    ...
    0 == this.$element.find(".arcu-submenu-container.active").length
      ? this.$element
          .find(".messangers-list")
          .removeClass("arcu-submenu-active")
      : (this.$element
          .find(".arcu-submenu-container.active")
          .children(".arcu-submenu-header")
          .addClass("active"),
        this.$element
          .find(".arcu-submenu-container.active")
          .children(".arcu-submenu")
          .addClass("active"));
  };
  d.prototype.showSubmenu = function (a) {
    this.$element.find(".arcu-submenu-container").removeClass("active");
    this.$element
      .find(".arcu-submenu-container .arcu-submenu")
      .removeClass("active");
    ...
    b(a.id)
      .parent()
      .children(".arcu-submenu-container")
      .addClass("active")
      .addClass("animated");
    b(a.id)
      .parent()
  ...
  b.fn.contactUs = function (a) {
    ...
    return this.each(function () {
      ...
      e ||
        ((e = new d(this, "object" == typeof a && a)),
