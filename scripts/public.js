    ...
    function checkSession() {
      ...
      if (
        ...
        if (
          ...
          Cookies.set("pys_session_limit", !0, { expires: now });
        ...
        try {
          if (
            ...
            if (!options.cookie.disabled_first_visit_cookie) {
              Cookies.set("pys_first_visit", !0, { expires: expires });
            } else {
        ...
        if (window.pysEddProductData.hasOwnProperty(download_id)) {
          ...
          if (window.pysEddProductData[download_id].hasOwnProperty(index)) {
            if (
              ...
              Utils.copyProperties(
                window.pysEddProductData[download_id][index].facebook.params,
                event.params
              );
              if (
    ...
    function mapParamsTov4(tag, name, param) {
      ...
      if (isv4(tag)) {
        ...
        switch (name) {
          ...
          case "EmailClick":
          case "TelClick": {
            let params = { event_category: "Key Actions", event_action: name };
            return params;
          }
          case "Form": {
            let params = { event_category: "Key Actions", event_action: name };
...
if (
  pysOptions.ajaxForServerEvent &&
  !Cookies.get("pbid") &&
  !(
    pysOptions.cookie.disabled_all_cookie ||
    pysOptions.cookie.externalID_disabled_by_api
  )
) {
  jQuery.ajax({
